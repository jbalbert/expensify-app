...
const expense1 = store.dispatch(addExpense({description : 'coffee', amount : 100, createdAt: 1000 }));
const expense2 = store.dispatch(addExpense({description : 'cleaning', amount : 200, createdAt: -1000}));
